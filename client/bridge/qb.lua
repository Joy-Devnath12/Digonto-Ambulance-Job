    ...
    if toggle then
        ...
        if Config.ClothingScript and Config.ClothingScript ~= 'core' then
            ...
            if model == 'mp_m_freemode_01' then
                data = clothes.male[jobGrade] or clothes.male[0] or clothes.male[1]
            elseif model == 'mp_f_freemode_01' then
                data = clothes.female[jobGrade] or clothes.female[0] or clothes.female[1]
            end
        ...
        if Config.ClothingScript == 'illenium-appearance' or Config.ClothingScript == 'fivem-appearance' then
            TriggerEvent(Config.ClothingScript .. ":client:reloadSkin", true)
        else
...
function openBossMenu(job)
    if GetResourceState('qbx_management'):find('start') then
